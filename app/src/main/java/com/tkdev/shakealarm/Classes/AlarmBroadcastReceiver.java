...
import com.tkdev.shakealarm.Services.Service_UpdateAlarm;
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (Objects.equals(intent.getAction(), ConstantsAndStatics.ACTION_DELIVER_ALARM)) {
			...
			PowerManager.WakeLock wakeLock = powerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK,
					"com.tkdev.shakealarm.Classes::AlarmRingServiceWakelockTag");
			...
			PowerManager powerManager = (PowerManager) context.getSystemService(POWER_SERVICE);
			PowerManager.WakeLock wakeLock = powerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK,
					"com.tkdev.shakealarm.Classes::AlarmUpdateServiceWakelockTag");
			wakeLock.acquire(60000);
